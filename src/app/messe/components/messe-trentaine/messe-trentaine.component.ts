...
@Component({
  selector: 'app-messe-trentaine',
  templateUrl: './messe-trentaine.component.html',
  styleUrls: ['./messe-trentaine.component.css']
})
export class MesseTrentaineComponent {
  form: FormGroup;
  currentStep = 1;

  defaultIntention: string = `Type d'intention`;
